...
namespace FusionExamples.Tanknarok
{
	...
	public class HitScan : Projectile
	{
		...
		public override void InitNetworkState(Vector3 ownerVelocity)
		{
			...
			impact = Runner.LagCompensation.Raycast(exit.position - 0.5f*exit.forward, exit.forward, _settings.range, Object.InputAuthority, out var hitinfo, _settings.hitMask.value, HitOptions.IgnoreInputAuthority | HitOptions.IncludePhysX);
